...
import background from './MedPlus.png';
...
const MedPlus = () => {
  return (
    <div className='content'>
      ...
      <p className="job">Hackaton mobile project made in React Native, SqLite and Android Studio. It's an app that assists the rescheduling of appointments.</p>
